...
@Doc.component('Alert')
@Doc.event('dismiss', 'Sent when the dismiss button is clicked')
@Doc.defaultSlot('alert content')
export class Alert extends mixins(UidMixin) {
  @Doc.prop('whether alert is dismissible', { type: Boolean, default: true })
  public dismissible!: boolean;

  @Doc.model('whether alert is visible', { event: 'visible', default: true, type: Boolean })
  public visible!: boolean;

  @Doc.prop('alert type', { acceptableValues: AlertTypes, default: 'default' })
