...
@Doc.component('Calendar')
@Doc.mixins(PresentDateMixin, DisplayedDateMixin, DateSelectionMixin)
export class Calendar extends CalendarBase {
  public $tsxProps!: ComponentProps<Props>;

  @Doc.prop('whether header is shown', { type: Boolean, default: true })
  public headerVisible!: boolean;

  @Doc.prop('maximum date', { readableDefaultValue: 'now + 10 years', type: Date, default: () => dateWithYearsFromNow(10)})
  public maxDate!: Date;

  @Doc.prop('minimum date', { readableDefaultValue: 'now - 10 years', type: Date, default: () => dateWithYearsFromNow(-10)})
  public minDate!: Date;
